...
const BodyPartPuzzle = () => {
  ...
  const puzzlePieces = [
    { id: 'head', name: 'Head', emoji: '🤔', correctPosition: { x, y }, currentPosition },
    { id: 'eyes', name: 'Eyes', emoji: '👀', correctPosition: { x, y }, currentPosition },
    { id: 'mouth', name: 'Mouth', emoji: '👄', correctPosition: { x, y }, currentPosition },
    { id: 'arms', name: 'Arms', emoji: '💪', correctPosition: { x, y }, currentPosition },
    { id: 'heart', name: 'Heart', emoji: '❤️', correctPosition: { x, y }, currentPosition },
    { id: 'hands', name: 'Hands', emoji: '🙌', correctPosition: { x, y }, currentPosition },
    { id: 'legs', name: 'Legs', emoji: '🦵', correctPosition: { x, y }, currentPosition },
    { id: 'feet', name: 'Feet', emoji: '🦶', correctPosition: { x, y }, currentPosition }
  ];
