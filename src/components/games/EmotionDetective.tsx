...
const EmotionDetective: React.FC = () => {
  ...
  const emotions: Emotion[] = [
    { id: 1, name: 'Happy', emoji: '😊', description: 'feeling joyful and pleased', color: 'bg-yellow-200' },
    { id: 2, name: 'Sad', emoji: '😢', description: 'feeling down or upset', color: 'bg-blue-200' },
    { id: 3, name: 'Angry', emoji: '😠', description: 'feeling mad or frustrated', color: 'bg-red-200' },
    { id: 4, name: 'Surprised', emoji: '😮', description: 'feeling shocked or amazed', color: 'bg-purple-200' },
    { id: 5, name: 'Scared', emoji: '😨', description: 'feeling afraid or worried', color: 'bg-gray-200' },
    { id: 6, name: 'Excited', emoji: '🤩', description: 'feeling thrilled and energetic', color: 'bg-orange-200' }
  ];

  const emotionPairs: EmotionPair[] = [
    {
      emotion: emotions[0], // Happy
      situations: [
  ...
  const handleEmotionSelect = (emotionId: number) => {
    ...
    setTimeout(() => {
      if (currentRound + 1 >= emotionPairs.length) {
        ...
        playNarration(`Congratulations Detective! You completed all the emotion challenges with a score of ${score + (emotionId === currentPair.emotion.id ? 10 : 0)}!`);
      } else {
    ...
    <div className="min-h-screen bg-warm-white p-4">
      ...
      <div className="max-w-4xl mx-auto pt-20">
        <div className="text-center mb-8">
          <h1 className="text-4xl md:text-5xl font-bold text-soft-yellow mb-4">
                      ...
                      <div
                        ...
                        className={`
                          ...
                          ${isCorrect ? 
                            ...
                            'border-white hover:border-orange-300 hover:scale-102 shadow-lg'
                          }
