...
export const BodyPartsQuiz: React.FC<BodyPartsQuizProps> = ({ onComplete }) => {
  ...
  const handleNext = () => {
    if (currentQuestion < questions.length - 1) {
      ...
      playNarration(`Great job! You got ${score + (selectedAnswer === questions[currentQuestion].correct ? 1 : 0)} out of ${questions.length} questions right!`);
    }
  };
