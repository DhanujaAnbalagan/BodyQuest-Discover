...
export const SensesQuiz: React.FC<SensesQuizProps> = ({ onComplete }) => {
  ...
  const handleNext = () => {
    if (currentQuestion < questions.length - 1) {
      ...
      playNarration(`Fantastic! You got ${score + (selectedAnswer === questions[currentQuestion].correct ? 1 : 0)} out of ${questions.length} questions right!`);
    }
  };
