            ...
            style={
              {
                ...
                "--sidebar-width-icon"_WIDTH_ICON,
                ...style,
...
>(
  (
    ...
    return (
      <div
        ref={ref}
        className="group peer hidden md text-sidebar-foreground"
        data-state={state}
...
>(({ className, ...props }, ref) => {
  ...
  return (
    <button
      ...
      className={cn(
        "absolute inset-y-0 z-20 hidden w-4 -translate-x-1/2 transition-all ease-linear after after-y-0 after-1/2 after-[2px] hover-sidebar-border group-data-[side=left]:-right-4 group-data-[side=right]-0 sm",
        "[[data-side=left]_&]-w-resize [[data-side=right]_&]-e-resize",
        "[[data-side=left][data-state=collapsed]_&]-e-resize [[data-side=right][data-state=collapsed]_&]-w-resize",
        "group-data-[collapsible=offcanvas]-x-0 group-data-[collapsible=offcanvas]-full group-data-[collapsible=offcanvas]-sidebar",
...
>(({ className, asChild = false, ...props }, ref) => {
  ...
  return (
    <Comp
      ...
      className={cn(
        "duration-200 flex h-8 shrink-0 items-center rounded-md px-2 text-xs font-medium text-sidebar-foreground/70 outline-none ring-sidebar-ring transition-[margin,opa] ease-linear focus-visible-2 [&>svg]-4 [&>svg]-0",
...
>(({ className, asChild = false, ...props }, ref) => {
  ...
  return (
    <Comp
      ...
      className={cn(
        "absolute right-3 top-3.5 flex aspect-square w-5 items-center justify-center rounded-md p-0 text-sidebar-foreground outline-none ring-sidebar-ring transition-transform hover-sidebar-accent hover-sidebar-accent-foreground focus-visible-2 [&>svg]-4 [&>svg]-0",
